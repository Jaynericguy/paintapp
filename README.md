...
See my django app and postgres backend here... http://junder.ddns.net:8000 ==> Need to be able to edit and remove the rooms otherwise all is working and took me about 6hrs total time to get to where it is now 
